...
extension DateTimeExtension on DateTime {
  ...
  String formatYearMonthDayJaString() {
    return DateFormat("yyyy年MM月dd日", 'ja_JP').format(this);
  }

  String formatYearMonthJaString() {
    return DateFormat("yyyy年MM月", 'ja_JP').format(this);
  }

  String formatYearMonthDayWeekJaString() {
    return DateFormat("yyyy年MM月dd日（E）", 'ja_JP').format(this);
  }

  String formatYearMonthDayWeekTimeJaString() {
    return DateFormat("yyyy年MM月dd日（E）H:mm", 'ja_JP').format(this);
  }
...
extension StringDateTimeExt on String {
  ...
  String remainingTime() {
    ...
    if (remainingDuration.inDays >= 1) {
      return ' (あと${remainingDuration.inDays}日)';
    }

    if (remainingDuration.inHours >= 1) {
      return ' (あと${remainingDuration.inHours}時間)';
    }

    return ' (あと${remainingDuration.inMinutes}分)';
  }
  ...
  String paymentDeadlineTime() {
    ...
    if (remainingDuration.inDays >= 1) {
      return '入金〆切まであと${remainingDuration.inDays}日';
    }
    if (remainingDuration.inHours >= 1) {
      return '入金〆切まであと${remainingDuration.inHours}時間';
    }
    return '入金〆切まであと${remainingDuration.inMinutes}分';
  }
